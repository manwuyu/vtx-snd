    ...
    loadMapJs(){
        this.loadMapComplete = new Promise((resolve,reject)=>{
            if(window.BMap){
                ...
                configUrl.httpOrhttps== 'https'?window.HOST_TYPE = "2": '';
                $.getScript(`${configUrl.httpOrhttps}://api.map.baidu.com/getscript?v=2.0&ak=EVlFc6DZzAzU5avIjoxNcFgQ`,()=>{
                    ...
                    let InfoBox = new Promise(function (resolve, reject) {
                        $.getScript(`${configUrl.mapServerURL}/InfoBox_min.js`, function () {
                            resolve();
                        });
                    });
                    let LuShu = new Promise(function (resolve, reject) {
                        $.getScript(`${configUrl.mapServerURL}/LuShu_min.js`, function () {
                            resolve();
                        });
                    });
