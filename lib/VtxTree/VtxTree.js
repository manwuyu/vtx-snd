...
var VtxTree = function (_React$Component) {
	(0, _inherits3.default)(VtxTree, _React$Component);

	function VtxTree(props) {
		(0, _classCallCheck3.default)(this, VtxTree);

		var _this = (0, _possibleConstructorReturn3.default)(this, (VtxTree.__proto__ || (0, _getPrototypeOf2.default)(VtxTree)).call(this, props));
  ...
  */
	...
	(0, _createClass3.default)(VtxTree, [{
		key: 'onRightClick',
   ...
   */
		...
		value: function shouldComponentUpdate(nextProps, nextState) {
			var t = this;
			var oldProps = (0, _extends3.default)({}, t.props);
			var newProps = (0, _extends3.default)({}, nextProps);
			var oldState = (0, _extends3.default)({}, t.state);
			var newState = (0, _extends3.default)({}, nextState);
