...
var VtxModalList = function (_React$Component) {
    (0, _inherits3.default)(VtxModalList, _React$Component);

    function VtxModalList(props) {
        (0, _classCallCheck3.default)(this, VtxModalList);

        var _this = (0, _possibleConstructorReturn3.default)(this, (VtxModalList.__proto__ || (0, _getPrototypeOf2.default)(VtxModalList)).call(this, props));
    ...
    (0, _createClass3.default)(VtxModalList, [{
        ...
        value: function repeteAjax() {
            ...
            var ajaxPropmise = new _promise2.default(function (resolve, reject) {
                $.ajax((0, _extends3.default)({}, headers, {
        ...
        value: function renderChildren() {
            ...
            var chil = t.props.children,
                newRepeteKeyList = [],
                orl = (0, _extends3.default)({}, t.repeteList);
            //清空缓存,避免缓存数据
            if (!!chil) {
                if (!chil.length) {
                    return null;
        ...
        value: function cloneComponent(elem, index) {
            ...
            var e = _react2.default.cloneElement(elem, (0, _extends3.default)({}, elem.props, {
                'data-modallist': '',
                style: (0, _extends3.default)({}, elem.props.style, {
                    width: '100%'
                }),
                className: (elem.props.className || '') + ' ' + (isMaxNum ? eval((mld.layout || {}).maxNum) >= 100 ? 'maxNum-input55' : 'maxNum-input45' : '')
                    ...
                    if (reg.repete && e.target.value) {
                        ...
                        t.onlyRecord = (0, _defineProperty3.default)({}, index, i);
                        t.repeteAjax({
                            url: (reg.repete || {}).url || '',
                            ...
                            if (i >= t.onlyRecord[index]) {
                                t.repeteList[index] = (0, _extends3.default)({}, t.repeteList[index], {
                                    isRepete: data.data,
                                    errorMsg: data.msg || ''
                                });
                                t.setState({
            ...
            t.repeteList[index] = (0, _extends3.default)({
        ...
        value: function submit() {
            ...
            return new _promise2.default(function (resolve, reject) {
                ...
                if (data) {
                    ...
                    t.allRecord = ind;
                    return _promise2.default.all(plist).then(function (values) {
                        if (ind >= t.allRecord) {
                            var isRequest = true;
                            for (var _i2 = 0; _i2 < values.length; _i2++) {
                                t.repeteList[ii[_i2]] = (0, _extends3.default)({}, t.repeteList[ii[_i2]], {
...
function LayoutComponent(props) {
    ...
    var s = {};
    if (width) {
        s = (0, _extends3.default)({}, style, { width: width + '%' });
    } else {
        s = (0, _extends3.default)({}, style);
    }
    return _react2.default.createElement(
        'div',
        {
