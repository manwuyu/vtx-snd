...
function distinct(ary) {
    var pts = [].concat((0, _toConsumableArray3.default)(ary));
...
var VtxSearchMap = function (_React$Component) {
    (0, _inherits3.default)(VtxSearchMap, _React$Component);

    function VtxSearchMap(props) {
        (0, _classCallCheck3.default)(this, VtxSearchMap);

        var _this = (0, _possibleConstructorReturn3.default)(this, (VtxSearchMap.__proto__ || (0, _getPrototypeOf2.default)(VtxSearchMap)).call(this, props));
    ...
    (0, _createClass3.default)(VtxSearchMap, [{
        key: 'callback',
        ...
        value: function drawLocationPoint() {
            ...
            if (this.props.mapType !== 'gmap' || this.map.state.gis.extent && !!this.map.state.gis.extent.xmax) {
                ...
                if (this.props.editParam && (this.props.graphicType == 'polyline' || this.props.graphicType == 'polygon')) {
                    editGraphic = (0, _extends3.default)({}, this.props.editParam, { id: 'drawnGraph' });
            ...
            searchPoints.then(function (results) {
                if (results.length > 0) {
                    ...
                    for (var i = 0; i < results.length; i++) {
                        var r = results[i];
                        lsp.push((0, _extends3.default)({}, results[i], {
        ...
        value: function render() {
            ...
            if (graphicType == 'point') {
                mapPoints = [].concat((0, _toConsumableArray3.default)(locationPoint), (0, _toConsumableArray3.default)(listPoint));
            } else {
                mapPoints = [].concat((0, _toConsumableArray3.default)(listPoint));
            }
            ...
            if (isShowOtherGraph) {
                ...
                if (otherGraph) {
                    mapPoints = [].concat((0, _toConsumableArray3.default)(mapPoints), (0, _toConsumableArray3.default)(otherGraph.point || []));
                    mapLines = [].concat((0, _toConsumableArray3.default)(mapLines), (0, _toConsumableArray3.default)(otherGraph.polyline || []));
                    mapPolygons = [].concat((0, _toConsumableArray3.default)(mapPolygons), (0, _toConsumableArray3.default)(otherGraph.polygon || []));
                    mapCircles = [].concat((0, _toConsumableArray3.default)(mapCircles), (0, _toConsumableArray3.default)(otherGraph.circle || []));
                }
            }
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        mapType == 'gmap' ? '' : [_react2.default.createElement(_input2.default, (0, _extends3.default)({ key: '1' }, InputProps)), _react2.default.createElement(
                            _button2.default,
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(_VtxMap.VtxMap, (0, _extends3.default)({
