    ...
    (0, _createClass3.default)(Map, [{
            ...
            this.loadMapComplete = new _promise2.default(function (resolve, reject) {
                if (window.google) {
                    ...
                    $.getScript('http://ditu.google.cn/maps/api/js?key=AIzaSyAelEHQosKi09YLhXwmw3OR5ggScxOda2A&libraries=geometry,visualization,drawing', function () {
                        ...
                        var OmapCluster = new _promise2.default(function (resolve, reject) {
                            $.getScript(_default2.default.mapServerURL + '/omapCluster.js', function () {
                                resolve();
                            });
                        });
                        _promise2.default.all([PointCollection, OmapCluster]).then(function () {
                            resolve(t.omap = window.google.maps);
                        });
                    });
                }
        ...
        value: function setVisiblePoints(obj) {
                    ...
                    t.GM.getMoreGraphicParam(ids).map(function (item, index) {
                        ...
                        switch (item.geometryType) {
                            case 'point':
                                ...
                                break;
                            case 'polyline':
                                (_alnglat = alnglat).push.apply(_alnglat, (0, _toConsumableArray3.default)(item.geometry.paths));
                                break;
                            case 'polygon':
                                (_alnglat2 = alnglat).push.apply(_alnglat2, (0, _toConsumableArray3.default)(item.geometry.rings));
                                break;
                            case 'circle':
                                alnglat.push([item.geometry.x, item.geometry.y]);
                                break;
            ...
            switch (obj.fitView) {
                ...
                case 'circle':
                    ...
                    break;
                case 'all':
                    ls = getLngLats([].concat((0, _toConsumableArray3.default)(pointIds), (0, _toConsumableArray3.default)(lineIds), (0, _toConsumableArray3.default)(polygonIds), (0, _toConsumableArray3.default)(circleIds)));
                    break;
                default:
                    var ids = [];
        ...
        value: function addLine(mapLines, type) {
            ...
            mapLines.map(function (item, index) {
                ...
                //创建线对象
                var line = new google.maps.Polyline((0, _extends3.default)({}, lineOption, { path: linePath }));
                //判断线显示和隐藏
                if (cg.isHidden) {
        ...
        value: function addPolygon(mapPolygons) {
            ...
            mapPolygons.map(function (item, index) {
                ...
                //创建面对象
                var polygon = new google.maps.Polygon((0, _extends3.default)({}, polygonOption, { paths: polygonPath }));
                //添加面至地图
        ...
        value: function addCircle(mapCircles) {
            ...
            mapCircles.map(function (item, index) {
                ...
                //创建圆图元实例
                var circle = new google.maps.Circle((0, _extends3.default)({}, circleOption, {
                    radius: item.radius,
                    center: centerPoint
                }));
                //添加圆至地图
        ...
        value: function heatMapOverlay() {
            ...
            if (cg.gradient) {
                ...
                option.gradient = [].concat((0, _toConsumableArray3.default)(option.gradient), (0, _toConsumableArray3.default)(sortArray.sort(function (a, b) {
                    return a.key > b.key;
                }).map(function (item) {
                    return item.value;
                })));
        ...
        */
        ...
        value: function vtxRangingTool(mapRangingTool) {
            ...
            var gids = [].concat((0, _toConsumableArray3.default)(lineIds), (0, _toConsumableArray3.default)(polygonIds), (0, _toConsumableArray3.default)(circleIds));
                    ...
                    var fun = function fun() {
                        ...
                        if (t.rangingTool.isRanging) {
                            ...
                            if (t.rangingTool.line.paths.length == 2) {
                                ...
                                t.updateLine([(0, _extends3.default)({}, t.rangingTool.line, {
                                    paths: [].concat((0, _toConsumableArray3.default)(t.rangingTool.line.paths))
                                })]);
                            }
                            //双击 测距结束
                            if (status == 'dbl') {
                                ...
                                //缓存当前这一条测距数据
                                t.rangingTools[rangkey] = (0, _extends3.default)({}, t.rangingTool);
                                //回调测距参数
                                if (t.rangingTool.mapRangingTool) {
            ...
            if (!t.rangingToolMoveFun) {
                t.rangingToolMoveFun = function (e) {
                    //获取测距提示点位
                    var rp = (0, _extends3.default)({}, t.GM.getGraphicParam('vtx_g_rang_showRangTool').attributes);
                    //删除多余数据,避免other层级太多
                    delete rp.other;
            ...
            if (!t.rangingToolEndFun) {
                t.rangingToolEndFun = function (e) {
                    ...
                    if (t.rangingTool.isRanging) {
                        ...
                        t.rangingTool = (0, _extends3.default)({}, t.rangingTool, {
                            isRanging: false, //是否开启状态
                            line: {}, //线缓存
                            points: [], //点
                            distance: 0, //测距长度
        ...
        value: function moveTo(id, lnglat, delay, autoRotation, urlright, urlleft) {
            ...
            if (s.equals(e)) {
                ...
                if (autoRotation && !gc.isMarkerContent) {
                    ...
                    gc.setIcon((0, _extends3.default)({}, icon, { url: iconUrl.setRotation(ddeg).getUrl() }));
                }
                //拆分延迟移动定位
