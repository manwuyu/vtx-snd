...
var VortexAMap = function (_React$Component) {
    (0, _inherits3.default)(VortexAMap, _React$Component);

    function VortexAMap(props) {
        (0, _classCallCheck3.default)(this, VortexAMap);

        //初始化 图元管理方法
        var _this = (0, _possibleConstructorReturn3.default)(this, (VortexAMap.__proto__ || (0, _getPrototypeOf2.default)(VortexAMap)).call(this, props));
    ...
    (0, _createClass3.default)(VortexAMap, [{
        key: 'loadMapJs',
            ...
            this.loadMapComplete = new _promise2.default(function (resolve, reject) {
                if (window.AMap) {
                    ...
                    $.getScript(_default2.default.mapServerURL + '/A_content.js', function () {
                        $.getScript(_default2.default.httpOrhttps + '://webapi.amap.com/maps?v=1.4.14&key=e59ef9272e3788ac59d9a22f0f8cf9fe&plugin=AMap.MarkerClusterer,AMap.Scale,AMap.ToolBar,AMap.DistrictSearch,AMap.RangingTool,AMap.MouseTool,AMap.PolyEditor,AMap.CircleEditor,AMap.PlaceSearch,AMap.Heatmap', function () {
                            ...
                            _promise2.default.all([PointCollection]).then(function () {
                                (function setTime() {
        ...
        value: function createMap(divId) {
            ...
            $($('#' + mapId + ' .amap-layers')[0]).append('<div class=\'vtx_gmap_html_pointCollection_a\' id=\'' + t.pointCollectionId + '\' ></div>');
            //聚合点类对象
            ...
            if (t.props.showControl) {
                ...
                //比例尺工具对象
                t.tool = new AMap.ToolBar((0, _extends3.default)({
                    position: zlt,
                    offset: offsetT,
                    locate: false
                }, tp));
        ...
        value: function setVisiblePoints(obj) {
            ...
            switch (obj.fitView) {
                ...
                case 'circle':
                    ...
                    break;
                case 'all':
                    var pts = [].concat((0, _toConsumableArray3.default)(t.state.gis.getAllOverlays('marker')), (0, _toConsumableArray3.default)(t.state.gis.getAllOverlays('polyline')), (0, _toConsumableArray3.default)(t.state.gis.getAllOverlays('polygon')), (0, _toConsumableArray3.default)(t.state.gis.getAllOverlays('circle')));
            ...
            mapLines.map(function (item, index) {
                ...
                var lineOption = {
                    ...
                    path: (item.paths || []).map(function (itt, indd) {
                        return [].concat((0, _toConsumableArray3.default)(itt));
                    }),
                    cursor: 'pointer',
                    bubble: true
                };
