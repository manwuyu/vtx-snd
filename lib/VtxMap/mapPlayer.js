...
var MapPlayer = function () {
    function MapPlayer(_ref) {
        ...
        (0, _classCallCheck3.default)(this, MapPlayer);
    ...
    (0, _createClass3.default)(MapPlayer, [{
        key: '_redraw',
        value: function _redraw() {
            ...
            if (this._currentIndex < this.path.length) {
                ...
                var pointObj = (0, _extends3.default)({}, currentPoint, {
                    id: this._pointId,
                    latitude: currentPoint.latitude,
                    longitude: currentPoint.longitude
                }, this.pointSetting, {
                    config: (0, _extends3.default)({}, this.pointSetting.config || {}, {
        ...
        value: function _generateSupplyPoints(p1, p2) {
            ...
            // 需要补点
                    ...
                    for (var i = 1; i <= supplementNum; i++) {
                        supplementPoints.push((0, _extends3.default)({}, this.path[this._currentIndex], {
        ...
        value: function setPlayRate(newPlayRate) {
            ...
            if (this._supplementPoints.length > 0) {
                ...
                this._supplementPoints = [].concat((0, _toConsumableArray3.default)(this._supplementPoints.slice(0, this._currentSupplementIndex + 1)), (0, _toConsumableArray3.default)(newSpPoints));
            }
        }
        // 设置当前播放点位的位置
