...
var OptimizingPointMap = function (_React$Component) {
    (0, _inherits3.default)(OptimizingPointMap, _React$Component);

    function OptimizingPointMap(props) {
        (0, _classCallCheck3.default)(this, OptimizingPointMap);

        var _this = (0, _possibleConstructorReturn3.default)(this, (OptimizingPointMap.__proto__ || (0, _getPrototypeOf2.default)(OptimizingPointMap)).call(this, props));
    ...
    (0, _createClass3.default)(OptimizingPointMap, [{
        key: 'resetPoints',
...
var mapPointsProcessor = function () {
    function mapPointsProcessor(gridSpacing) {
        (0, _classCallCheck3.default)(this, mapPointsProcessor);
    ...
    (0, _createClass3.default)(mapPointsProcessor, [{
        key: 'resetMapConfig',
        ...
        value: function pointFilter(param) {
            ...
            var filteredPoints = [].concat((0, _toConsumableArray3.default)(reservedPoints));
