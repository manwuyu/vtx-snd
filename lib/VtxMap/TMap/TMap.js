...
var TMap = function (_React$Component) {
    (0, _inherits3.default)(TMap, _React$Component);

    function TMap(props) {
        (0, _classCallCheck3.default)(this, TMap);

        //初始化 图元管理方法
        var _this = (0, _possibleConstructorReturn3.default)(this, (TMap.__proto__ || (0, _getPrototypeOf2.default)(TMap)).call(this, props));
            ...
            this.loadMapComplete = new _promise2.default(function (resolve, reject) {
                if (window.T) {
                    ...
                    $.getScript(_default2.default.mapServerURL + '/T_content.js', function () {
                        $.getScript(_default2.default.httpOrhttps + '://api.tianditu.gov.cn/api?v=4.0&tk=e781ae595c43649431fb7270328e0669', function () {
                            ...
                            var ImageOverlays = new _promise2.default(function (resolve, reject) {
                            ...
                            //     })
                            // });
                            _promise2.default.all([Heatmap, PointCollection, ImageOverlays /*,components*/]).then(function () {
                                if (t.waitInit) {
                ...
                t.GM.getMoreGraphic(ids).map(function (item, index) {
                    ...
                    switch (item.getType()) {
                        ...
                        case 2:
                            ...
                            break;
                        case 4:
                            alnglat.push.apply(alnglat, (0, _toConsumableArray3.default)(item.getLngLats()));
                            break;
                        case 5:
                            //多边形 返回的是 三维数组
                            alnglat.push.apply(alnglat, (0, _toConsumableArray3.default)(item.getLngLats()[0]));
                            break;
                        case 8:
        ...
        value: function addLine(mapLines, type) {
            ...
            mapLines.map(function (item, index) {
                ...
                var pts = item.paths.map(function (itm, ind) {
                    return [].concat((0, _toConsumableArray3.default)(itm));
                });
            ...
            if (typeof t.props.moveEnd === "function") {
                t.state.gis.addEventListener('moveend', function (e) {
                    ...
                    if (mapPane.style.top) {
                        ...
                        var matchList = mapPane.style.transform.match(/translate\((-?\d*)+px,\s*(-?\d*)+px\)/) || [];
        ...
        value: function pointAnimation(id, marker) {
            ...
            if (!!marker) {
                ...
                t.animTimer[id] = setInterval(function () {
                    //点被隐藏时,没有执行,定时不关
                    if (marker.getIcon()) {
                        var shape = (0, _extends3.default)({}, marker.getIcon().getIconAnchor());
                        //初始数据  点位有变动,重新刷新数据
            ...
            t.moveToTimer = setInterval(function () {
                ...
                for (var _i = 0; _i < nowMovePoints.length; _i++) {
                    ...
                    if (!gc) {
                        ...
                        gc.setLngLat(lglt);
                        t.GM.setGraphicParam(id, (0, _extends3.default)({}, t.GM.getGraphicParam(id), { deg: ddeg }));
                        //旋转角度
