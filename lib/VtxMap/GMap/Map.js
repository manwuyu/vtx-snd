...
var ArcgisMap = function (_React$Component) {
    (0, _inherits3.default)(ArcgisMap, _React$Component);

    function ArcgisMap(props) {
        (0, _classCallCheck3.default)(this, ArcgisMap);

        var _this = (0, _possibleConstructorReturn3.default)(this, (ArcgisMap.__proto__ || (0, _getPrototypeOf2.default)(ArcgisMap)).call(this, props));
    ...
    (0, _createClass3.default)(ArcgisMap, [{
        key: 'loadMapJs',
        value: function loadMapJs() {
            this.loadMapComplete = new _promise2.default(function (resolve, reject) {
                if (window.GMap) {
                    resolve(window.GMap);
                } else {
                    //加载 js
                    ...
                    $.getScript(_default2.default.arcgisServerURL + '/html/js/arcgis_js_api/library/3.9/3.9/init.js', function () {
                        var Heatmap = new _promise2.default(function (resolve, reject) {
                            $.getScript(_default2.default.mapServerURL + '/gisheatmap.js', function () {
                                resolve();
                            });
                        });
                        var PointCollection = new _promise2.default(function (resolve, reject) {
                            $.getScript(_default2.default.mapServerURL + '/GPointCollection.js', function () {
                                resolve();
                            });
                        });
                        _promise2.default.all([Heatmap, PointCollection]).then(function () {
        ...
        value: function init() {
            ...
            var event = function event() {
                    ...
                    if (t.rangingTool.isRanging) {
                        ...
                        if (t.rangingTool.line.paths.length == 2) {
                            ...
                            t.rangingTool.line = {
                                ...
                                paths: [].concat((0, _toConsumableArray3.default)(t.rangingTool.line.paths)),
                                config: {
                                    color: '#ff0000',
                                    lineWidth: 2,
                                    lineType: 'solid'
                            ...
                            t.updateLine([(0, _extends7.default)({}, t.rangingTool.line, {
                                paths: [].concat((0, _toConsumableArray3.default)(t.rangingTool.line.paths))
                            })]);
                        }
                        //双击 测距结束
                        if (status == 'dbl') {
                            ...
                            //缓存当前这一条测距数据
                            t.rangingTools[rangkey] = (0, _extends7.default)({}, t.rangingTool);
                            //回调测距参数
                            ...
                            t.rangingTool = (0, _extends7.default)({}, t.rangingTool, {
                                isRanging: false, //是否开启状态
                                line: {}, //线缓存
                                points: [], //点
                                distance: 0 //测距长度
                ...
                t.state.gis.on('mouse-move', function (e) {
                    ...
                    if (t.rangingTool.isRanging) {
                        //获取测距提示点位
                        var rp = (0, _extends7.default)({}, t.GM.getGraphicParam('vtx-g-rang-showRangTool').attributes);
                        //删除多余数据,避免other层级太多
                        delete rp.other;
                    ...
                    if (t.editId && t.canMoveLabel) {
                        t.mouseNowPosition = (0, _extends7.default)({}, t.mouseNowPosition, {
                            x: e.mapPoint.x,
                            y: e.mapPoint.y
                        });
                    }
                ...
                t.state.gis.graphics.on('click', function (e) {
                    ...
                    if ((0, _typeof3.default)(e.graphic.attributes) == 'object') {
                        //点击图元的id
                        //判断是否点击的测距关闭点位
        ...
        value: function createMap() {
            ...
            var map = window.VtxMap[mapId] = t.state.gis = new GMap(t.props.mapId.toString(), (0, _extends7.default)({
                autoResize: true,
                logo: false,
                isKeyboardNavigation: false,
                showAttribution: true,
                backgroundColor: '#f1f1f1',
                extent: new esri.geometry.Extent((0, _extends7.default)({}, fullExtent, {
                    spatialReference: (0, _defineProperty3.default)({}, t.wkidStr, t.wkid)
                }))
            }, options));
        ...
        value: function addMapLayers() {
            ...
            var services = [].concat((0, _toConsumableArray3.default)(mapServer.services || [])),
                servs = [];
                    ...
                    case 'wmts':
                        for (var _i = 0; _i < url.length; _i++) {
                            var tileInfo = new esri.layers.TileInfo({
                                ...
                                "spatialReference": new esri.SpatialReference((0, _defineProperty3.default)({}, t.wkidStr, t.wkid || 4326)),
                                "rows": 256,
                                "cols": 256,
                                "origin": mapServer.origin || { x: -180, y: 90 },
                                "lods": mapServer.lods || []
                            });
                            var tileExtent = new esri.geometry.Extent(mapServer.fullExtent.xmin, mapServer.fullExtent.ymin, mapServer.fullExtent.xmax, mapServer.fullExtent.ymax, new esri.SpatialReference((0, _defineProperty3.default)({}, t.wkidStr, t.wkid)));
                            var inTileExtent = new esri.geometry.Extent(mapServer.initialExtent.xmin, mapServer.initialExtent.ymin, mapServer.initialExtent.xmax, mapServer.initialExtent.ymax, new esri.SpatialReference((0, _defineProperty3.default)({}, t.wkidStr, t.wkid)));
            ...
            if (services.length <= 0) {
                ...
                for (var _im = 0; _im < _MapToolFunction.defaultWmtsMapLayers.services.length; _im++) {
                    ...
                    var dtileExtent = new esri.geometry.Extent(_MapToolFunction.defaultWmtsMapLayers.fullExtent.xmin, _MapToolFunction.defaultWmtsMapLayers.fullExtent.ymin, _MapToolFunction.defaultWmtsMapLayers.fullExtent.xmax, _MapToolFunction.defaultWmtsMapLayers.fullExtent.ymax, new esri.SpatialReference((0, _defineProperty3.default)({}, t.wkidStr, t.wkid)));
                    var dinTileExtent = new esri.geometry.Extent(_MapToolFunction.defaultWmtsMapLayers.initialExtent.xmin, _MapToolFunction.defaultWmtsMapLayers.initialExtent.ymin, _MapToolFunction.defaultWmtsMapLayers.initialExtent.xmax, _MapToolFunction.defaultWmtsMapLayers.initialExtent.ymax, new esri.SpatialReference((0, _defineProperty3.default)({}, t.wkidStr, t.wkid)));
        ...
        value: function addPoint(mapPoints, type) {
            ...
            var t = this;
            var psids = [].concat((0, _toConsumableArray3.default)(t.state.pointIds));
            //添加绘制点
            if (type && type !== 'defined') {
                psids = [].concat((0, _toConsumableArray3.default)(t.state.drawIds[type]));
            }
            mapPoints.map(function (item, index) {
                ...
                if (item.markerContent) {
                    cg = (0, _extends7.default)({}, cg, { markerContentX: 0, markerContentY: 0, width: 100, height: 30 });
                }
                //初始化默认数据
                if (item.config) {
                    cg = (0, _extends7.default)({}, cg, item.config);
                }
                //创建arcgis的经纬度对象
                ...
                t.GM.setGraphic(item.id, marker).setGraphicParam(item.id, {
                    attributes: (0, _extends7.default)({}, item, { other: item }),
                    geometryType: 'point',
                    geometry: {
                        type: 'point',
                        x: item.longitude,
            ...
            if (type !== 'defined') {
                ...
                if (type) {
                    t.setState({
                        drawIds: (0, _extends7.default)({}, t.state.drawIds, (0, _defineProperty3.default)({}, type, psids))
                    });
                } else {
                    //所有点缓存在state中
                    t.setState({
        ...
        value: function addLine(mapLines, type) {
            var t = this;
            var lsids = [].concat((0, _toConsumableArray3.default)(t.state.lineIds));
            if (type && type !== 'defined') {
                lsids = [].concat((0, _toConsumableArray3.default)(t.state.drawIds[type]));
            }
            //遍历添加线(图元)
            mapLines.map(function (item, index) {
                ...
                var linePath = new esri.geometry.Polyline({
                    paths: [[].concat((0, _toConsumableArray3.default)(item.paths))],
                    spatialReference: { wkid: t.grwkid }
                });
                //线类型
                ...
                t.GM.setGraphic(item.id, line).setGraphicParam(item.id, {
                    attributes: (0, _extends7.default)({}, item, {
                        paths: item.paths,
                        other: item
                    }),
            ...
            if (type !== 'defined') {
                ...
                if (type) {
                    t.setState({
                        drawIds: (0, _extends7.default)({}, t.state.drawIds, (0, _defineProperty3.default)({}, type, lsids))
                    });
                } else {
                    t.setState({
                        lineIds: lsids
        ...
        value: function updateLine(mapLines) {
            ...
            mapLines.map(function (item, index) {
                ...
                //添加新的点位
                gc.geometry.addPath([].concat((0, _toConsumableArray3.default)(item.paths)));
        ...
        value: function addPolygon(mapPolygons, type) {
            var t = this;
            var pgsids = [].concat((0, _toConsumableArray3.default)(t.state.polygonIds));
            if (type) {
                pgsids = [].concat((0, _toConsumableArray3.default)(t.state.drawIds[type]));
            }
            //遍历添加面(图元)
            mapPolygons.map(function (item, index) {
                ...
                var rings = [].concat((0, _toConsumableArray3.default)(item.rings));
                if (item.rings[0][0] != item.rings[item.rings.length - 1][0] || item.rings[0][1] != item.rings[item.rings.length - 1][1]) {
                    rings = [].concat((0, _toConsumableArray3.default)(rings), [item.rings[0]]);
                }
                //处理面的点数据
            ...
            if (type) {
                t.setState({
                    drawIds: (0, _extends7.default)({}, t.state.drawIds, (0, _defineProperty3.default)({}, type, pgsids))
                });
            } else {
                t.setState({
                    polygonIds: pgsids
        ...
        value: function addCircle(mapCircles, type) {
            var t = this;
            var ccsids = [].concat((0, _toConsumableArray3.default)(t.state.circleIds));
            if (type) {
                ccsids = [].concat((0, _toConsumableArray3.default)(t.state.drawIds[type]));
            }
            ...
            if (type) {
                t.setState({
                    drawIds: (0, _extends7.default)({}, t.state.drawIds, (0, _defineProperty3.default)({}, type, ccsids))
                });
            } else {
                t.setState({
                    circleIds: ccsids
        ...
        value: function heatMapOverlay() {
            ...
            if (d.config) {
                cg = (0, _extends7.default)({}, cg, d.config);
            }
            if (!t.heatmap) {
        ...
        value: function clickGraphic(id, e) {
            ...
            if (typeof t.props.clickGraphic === "function") {
                ...
                var obj = {
                    ...
                    attributes: (0, _extends7.default)({}, param.attributes.other, { config: param.attributes.config }), //添加时图元信息
        ...
        value: function setCenter(gt) {
            ...
            if (gt) {
                ...
                t.state.gis.centerAt(new esri.geometry.Point(gt[0], gt[1], new esri.SpatialReference((0, _defineProperty3.default)({}, t.wkidStr, t.wkid))));
            }
        }
        //设置地图比例尺
        ...
        */
        ...
        value: function setVisiblePoints(arg, type) {
            ...
            if (ary[0] instanceof Array) {
                obj = [].concat((0, _toConsumableArray3.default)(obj), (0, _toConsumableArray3.default)(ary));
            } else {
                for (var i = 0; i < ary.length; i++) {
                    ...
                    switch (g.geometry.type) {
                        ...
                        case 'circle':
                            ...
                            break;
                        case 'polyline':
                            obj = [].concat((0, _toConsumableArray3.default)(obj), (0, _toConsumableArray3.default)(g.geometry.paths));
                            break;
                        case 'polygon':
                            obj = [].concat((0, _toConsumableArray3.default)(obj), (0, _toConsumableArray3.default)(g.geometry.rings));
                            break;
                    }
                }
            }
            ...
            if (_extent.xmin && _extent.xmax && _extent.ymin && _extent.ymax) {
                ...
                var ext = new esri.geometry.Extent((0, _extends7.default)({}, _extent, { spatialReference: (0, _defineProperty3.default)({}, t.wkidStr, t.wkid) }));
        ...
        value: function getGraphic(id) {
            ...
            switch (gp.geometryType) {
                case 'point':
                    lng = gg.geometry.x;
                    lat = gg.geometry.y;
                    p = (0, _extends7.default)({}, gp, {
                        mapLayer: gg,
                        geometry: (0, _extends7.default)({}, gp.geometry, {
                            x: lng,
                            y: lat
                        }),
                        attributes: (0, _extends7.default)({}, gp.attributes, {
                            longitude: lng,
                            latitude: lat,
                            other: (0, _extends7.default)({}, gp.attributes.other, {
                                longitude: lng,
                                latitude: lat
                            })
                        })
        ...
        value: function clearAll() {
            ...
            var ps = [].concat((0, _toConsumableArray3.default)(pointIds)),
                ls = [].concat((0, _toConsumableArray3.default)(lineIds)),
                pgs = [].concat((0, _toConsumableArray3.default)(polygonIds)),
                cs = [].concat((0, _toConsumableArray3.default)(circleIds));
            // 删除点
            for (var i = 0; i < ps.length; i++) {
        ...
        value: function showControl() {
            ...
            switch (t.props.showControl.type) {
                ...
                case 'pan':
                case 'zoom':
                    $('#' + t.props.mapId + '_zoom_slider').css((0, _extends7.default)({}, location, {
                        display: 'block'
                    }));
                default:
                    $('#' + t.props.mapId + '_zoom_slider_show').css((0, _extends7.default)({}, ls));
                    break;
            }
        }
        //编辑图元
                    ...
                    if ('editGraphicChange' in t.props && typeof t.props.editGraphicChange == 'function') {
                        ...
                        if (eid == 'vtx-circleMove') {
                            ...
                            switch (obj.geometry.type) {
                                case 'polyline':
                                    obj.geometry = (0, _extends7.default)({}, obj.geometry, {
        ...
        value: function draw(obj) {
                ...
                t.drawToolbar.on('draw-complete', function (e) {
                    ...
                    if (t.drawParam.geometryType == 'point') {
                        t.addPoint([{
                            ...
                            config: (0, _extends7.default)({}, t.drawParam.parameter)
                        }], 'point');
                        //处理点返回参数
                        param = {
                            id: t.drawParam.data.id,
                    ...
                    if (t.drawParam.geometryType == 'polyline') {
                        ...
                        param = {
                            lnglatAry: lnglatAry,
                            id: t.drawParam.data.id,
                            geometry: (0, _extends7.default)({}, e.geometry, {
                                paths: e.geometry.paths[0],
                                _extent: _extent
                            }),
                            attributes: {
                    ...
                    if (t.drawParam.geometryType == 'polygon' || t.drawParam.geometryType == 'rectangle') {
                        var rs = [].concat((0, _toConsumableArray3.default)(e.geometry.rings[0]));
                        rs.pop();
                        t.addPolygon([{
                            id: t.drawParam.data.id,
                            rings: rs,
            ...
            drawParam.parameter = obj.parameter ? (0, _extends7.default)({}, obj.parameter) : {};
            drawParam.data = obj.data ? (0, _extends7.default)({}, obj.data) : {};
        ...
        value: function setAreaRestriction(areaRestriction) {
            ...
            t.areaRestriction = new esri.geometry.Extent((0, _extends7.default)({}, _et, { spatialReference: { wkid: t.grwkid }
            }));
        }
        //关闭区域限制
        ...
        value: function pointAnimation(id, marker) {
            ...
            if (!!marker) {
                ...
                t.animTimer[id] = setInterval(function () {
                    //点被隐藏时,没有执行,定时不关
                    if (marker.symbol) {
                        var shape = (0, _extends7.default)({}, marker.symbol);
                        //初始数据  点位有变动,重新刷新数据
            ...
            t.moveToTimer = setInterval(function () {
                ...
                for (var _i14 = 0; _i14 < nowMovePoints.length; _i14++) {
                    ...
                    if (!gc || !gc._graphicsLayer) {
                        ...
                        t.GM.setGraphicParam(id, (0, _extends7.default)({}, t.GM.getGraphicParam(id), { deg: ddeg }));
            ...
            var initData = function initData() {
                ...
                */
                if (mapPoints instanceof Array && !t.deepEqual(mapPoints, t.props.mapPoints)) {
                    ...
                    var _t$dealAdd = t.dealAdd(_addedData, [].concat((0, _toConsumableArray3.default)(pointIds), (0, _toConsumableArray3.default)(point))),
                        ads = _t$dealAdd.ads,
                        otherupds = _t$dealAdd.otherupds;

                    var _t$dealUpdate = t.dealUpdate(_updatedData, [].concat((0, _toConsumableArray3.default)(pointIds), (0, _toConsumableArray3.default)(point))),
                    ...
                    try {
                        for (var _iterator = (0, _getIterator3.default)(_deletedDataIDs), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                            var id = _step.value;
                    ...
                    t.addPoint([].concat((0, _toConsumableArray3.default)(ads), (0, _toConsumableArray3.default)(otherads)));
                    //更新
                    t.updatePoint([].concat((0, _toConsumableArray3.default)(upds), (0, _toConsumableArray3.default)(otherupds)));
                }
                /*
                    线数据处理
                    先全删除,再新增
                */
                if (mapLines instanceof Array && !t.deepEqual(mapLines, t.props.mapLines)) {
                    ...
                    var _t$dealAdd2 = t.dealAdd(_addedData2, [].concat((0, _toConsumableArray3.default)(lineIds), (0, _toConsumableArray3.default)(polyline))),
                        _ads = _t$dealAdd2.ads,
                        _otherupds = _t$dealAdd2.otherupds;

                    var _t$dealUpdate2 = t.dealUpdate(_updatedData2, [].concat((0, _toConsumableArray3.default)(lineIds), (0, _toConsumableArray3.default)(polyline))),
                    ...
                    try {
                        for (var _iterator2 = (0, _getIterator3.default)(_deletedDataIDs2), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                    ...
                    t.addLine([].concat((0, _toConsumableArray3.default)(_ads), (0, _toConsumableArray3.default)(_otherads)));
                    //更新
                    t.updateLine([].concat((0, _toConsumableArray3.default)(_upds), (0, _toConsumableArray3.default)(_otherupds)));
                }
                //画其他特例线专用
                if (customizedBoundary instanceof Array && !t.deepEqual(customizedBoundary, t.props.customizedBoundary)) {
                    ...
                    try {
                        for (var _iterator3 = (0, _getIterator3.default)(_deletedDataIDs3), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                ...
                */
                if (mapPolygons instanceof Array && !t.deepEqual(mapPolygons, t.props.mapPolygons)) {
                    ...
                    var _t$dealAdd3 = t.dealAdd(_addedData4, [].concat((0, _toConsumableArray3.default)(rectangle), (0, _toConsumableArray3.default)(polygon), (0, _toConsumableArray3.default)(polygonIds))),
                        _ads2 = _t$dealAdd3.ads,
                        _otherupds2 = _t$dealAdd3.otherupds;

                    var _t$dealUpdate3 = t.dealUpdate(_updatedData4, [].concat((0, _toConsumableArray3.default)(rectangle), (0, _toConsumableArray3.default)(polygon), (0, _toConsumableArray3.default)(polygonIds))),
                    ...
                    try {
                        for (var _iterator4 = (0, _getIterator3.default)(_deletedDataIDs4), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
                    ...
                    t.addPolygon([].concat((0, _toConsumableArray3.default)(_ads2), (0, _toConsumableArray3.default)(_otherads2)));
                    //更新
                    t.updatePolygon([].concat((0, _toConsumableArray3.default)(_upds2), (0, _toConsumableArray3.default)(_otherupds2)));
                }
                /*
                    圆数据处理
                    先全删除,再新增
                */
                if (mapCircles instanceof Array && !t.deepEqual(mapCircles, t.props.mapCircles)) {
                    ...
                    var _t$dealAdd4 = t.dealAdd(_addedData5, [].concat((0, _toConsumableArray3.default)(circleIds), (0, _toConsumableArray3.default)(circle))),
                        _ads3 = _t$dealAdd4.ads,
                        _otherupds3 = _t$dealAdd4.otherupds;

                    var _t$dealUpdate4 = t.dealUpdate(_updatedData5, [].concat((0, _toConsumableArray3.default)(circleIds), (0, _toConsumableArray3.default)(circle))),
                    ...
                    try {
                        for (var _iterator5 = (0, _getIterator3.default)(_deletedDataIDs5), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
                    ...
                    t.addCircle([].concat((0, _toConsumableArray3.default)(_ads3), (0, _toConsumableArray3.default)(_otherads3)));
                    //更新
                    t.updateCircle([].concat((0, _toConsumableArray3.default)(_upds3), (0, _toConsumableArray3.default)(_otherupds3)));
                }
                //绘制边界线
