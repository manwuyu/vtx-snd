...
var BaiduMap = function (_React$Component) {
    (0, _inherits3.default)(BaiduMap, _React$Component);

    function BaiduMap(props) {
        (0, _classCallCheck3.default)(this, BaiduMap);

        var _this = (0, _possibleConstructorReturn3.default)(this, (BaiduMap.__proto__ || (0, _getPrototypeOf2.default)(BaiduMap)).call(this, props));
    ...
    (0, _createClass3.default)(BaiduMap, [{
        key: 'loadMapJs',
        value: function loadMapJs() {
            this.loadMapComplete = new _promise2.default(function (resolve, reject) {
                if (window.BMap) {
                    ...
                    _default2.default.httpOrhttps == 'https' ? window.HOST_TYPE = "2" : '';
                    $.getScript(_default2.default.httpOrhttps + '://api.map.baidu.com/getscript?v=2.0&ak=EVlFc6DZzAzU5avIjoxNcFgQ', function () {
                        var DistanceTool = new _promise2.default(function (resolve, reject) {
                            $.getScript(_default2.default.mapServerURL + '/DistanceTool_min.js', function () {
                                resolve();
                            });
                        });
                        var TrafficControl = new _promise2.default(function (resolve, reject) {
                            $.getScript(_default2.default.mapServerURL + '/TrafficControl_min.js', function () {
                                resolve();
                            });
                        });
                        var MarkerClusterer = new _promise2.default(function (resolve, reject) {
                            $.getScript(_default2.default.mapServerURL + '/MarkerClusterer_min.js', function () {
                                resolve();
                            });
                        });
                        var AreaRestriction = new _promise2.default(function (resolve, reject) {
                            $.getScript(_default2.default.mapServerURL + '/AreaRestriction_min.js', function () {
                                resolve();
                            });
                        });
                        var DrawingManager = new _promise2.default(function (resolve, reject) {
                        ...
                        var GeoUtils = new _promise2.default(function (resolve, reject) {
                            $.getScript(_default2.default.mapServerURL + '/GeoUtils_min.js', function () {
                                resolve();
                            });
                        });
                        var TextIconOverlay = new _promise2.default(function (resolve, reject) {
                            $.getScript(_default2.default.mapServerURL + '/TextIconOverlay_min.js', function () {
                                resolve();
                            });
                        });
                        var InfoBox = new _promise2.default(function (resolve, reject) {
                            $.getScript(_default2.default.mapServerURL + '/InfoBox_min.js', function () {
                                resolve();
                            });
                        });
                        var LuShu = new _promise2.default(function (resolve, reject) {
                            $.getScript(_default2.default.mapServerURL + '/LuShu_min.js', function () {
                                resolve();
                            });
                        });
                        _promise2.default.all([DistanceTool, TrafficControl, MarkerClusterer, AreaRestriction, DrawingManager, Heatmap, GeoUtils, TextIconOverlay]).then(function () {
                            resolve(window.BMap);
                        });
                    });
                    $("<link>").attr({ rel: "stylesheet", type: "text/css", href: _default2.default.httpOrhttps + '://api.map.baidu.com/library/TrafficControl/1.4/src/TrafficControl_min.css' }).appendTo("head");
                }
            });
        }
        //初始化地图数据
        ...
        value: function addPoint(mapPoints, type) {
            ...
            mapPoints.map(function (item, index) {
                ...
                if (item.markerContent) {
                    cg = (0, _extends3.default)({}, cg, { markerContentX: 0, markerContentY: 0, width: 100, height: 30 });
                }
                //初始化默认数据
                if (item.config) {
                    cg = (0, _extends3.default)({}, cg, item.config);
                }
                ...
                if (item.markerContent) {
                    ...
                    markerOption = (0, _extends3.default)({}, markerOption, { icon: icon });
                    ...
                    _markerOption = (0, _extends3.default)({}, _markerOption, { icon: _icon });
                ...
                t.GM.setGraphic(item.id, marker).setGraphicParam(item.id, {
                    attributes: (0, _extends3.default)({}, item, { other: item }),
                    geometryType: 'point',
                    geometry: {
                        type: 'point',
                        x: item.longitude,
        ...
        value: function addLine(mapLines, type) {
            ...
            mapLines.map(function (item, index) {
                ...
                t.GM.setGraphic(item.id, line).setGraphicParam(item.id, {
                    attributes: (0, _extends3.default)({}, item, {
                        paths: item.paths,
                        other: item
                    }),
        ...
        value: function heatMapOverlay() {
            ...
            if (d.config) {
                cg = (0, _extends3.default)({}, cg, d.config);
            }
            if (!t.heatmap) {
        ...
        value: function clickGraphic(id, e) {
            ...
            if (typeof t.props.clickGraphic === "function") {
                ...
                var obj = {
                    ...
                    attributes: (0, _extends3.default)({}, param.attributes.other, { config: param.attributes.config }), //添加时图元信息
        ...
        */
            ...
            if (ids.length > 0) {
                ...
                for (var i = 0; i < ids.length; i++) {
                    switch ((t.GM.getGraphicParam(ids[i]) || {}).geometryType) {
                        ...
                        case 'polyline':
                        case 'polygon':
                            allLayers = [].concat((0, _toConsumableArray3.default)(allLayers), (0, _toConsumableArray3.default)(t.GM.getGraphic(ids[i]).getPath()));
                            break;
                        case 'circle':
        ...
        value: function getGraphic(id) {
            ...
            switch (gp.geometryType) {
                case 'point':
                    ...
                    p = (0, _extends3.default)({}, gp, {
                        mapLayer: gg,
                        geometry: (0, _extends3.default)({}, gp.geometry, {
                            x: lng,
                            y: lat
                        }),
                        attributes: (0, _extends3.default)({}, gp.attributes, {
                            longitude: lng,
                            latitude: lat,
                            other: (0, _extends3.default)({}, gp.attributes.other, {
                                longitude: lng,
                                latitude: lat
                            })
                        })
        ...
        value: function draw(obj) {
            ...
            drawParam.parameter = obj.parameter ? (0, _extends3.default)({}, obj.parameter) : {};
            drawParam.data = obj.data ? (0, _extends3.default)({}, obj.data) : {};
