...
var VortexDatagrid = function (_React$Component) {
    ...
    (0, _createClass3.default)(VortexDatagrid, [{
        ...
        value: function componentWillReceiveProps(nextProps) {
            // 默认显示隐藏列变化
            if (Array.isArray(nextProps.defaultVisibleCols) && !(0, _isEqual3.default)(this.props.defaultVisibleCols, nextProps.defaultVisibleCols)) {
                this.setState({
                    columnsVisibility: nextProps.columns.map(function (item) {
                        return {
                            title: item.title,
                            key: item.key,
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(_table2.default, (0, _extends3.default)({}, t.getNewProps(), { className: styles.data_tb })),
